		...
		if (cl != null)
		{
			...
			else 
			{
				final String html = StringUtil.concat("<html><body><center><br><br>"
						...
						+ "<a action=\"bypass _bbsclan_clanlist\"> CLAN LIST </a> &gt;"
						+ "<a action=\"bypass _bbsclan_clanhome;", String.valueOf(clanId), "\">"
						+ cl.getName() + "</a>"
						+ "</td></tr></table>"
						...
						+ "<tr><td height=10></td></tr>"
						+ "<tr><td fixWIDTH=5></td>"
						+ "<td fixwidth=290 valign=top>" + activeChar.getClan().getNotice() + "</td>"
						+ "<td fixWIDTH=5></td>"
